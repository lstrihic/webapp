...
type SessionFunc func(context.Context, *entity.SessionMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f SessionFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	mv, ok := m.(*entity.SessionMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.SessionMutation", m)
	}
	return f(ctx, mv)
}
